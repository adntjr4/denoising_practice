...
print(CBSD432_15.__getitem__(1))
#CBSD432_15.save_all_image('./dataset/BSD432', clean=True)

# CBSD432_25 = get_dataset_object('CBSD432')(add_noise='gau-25.', mask=None, aug=None, crop_size=None)
# CBSD432_25.save_all_image('./dataset/synthesized_BSD/CBSD432_25', syn_noisy=True)
